...
3. Ant Colony System  
4. Clonal Selection  
5. Flower Pollination Algorithm (my favorite)
...
where $\rho(a, b)$ represents the distance between cities $a$ and $b$. For testing (lau_15.txt instance), the global minimum is known as $f(\pi_0) = 291$.
...
\mathbf{x}_i = \begin{bmatrix}
        a_1 & a_2 & \dots & a_n
    \end{bmatrix}, \quad a_i \in \mathbb{Z}^+
$$
